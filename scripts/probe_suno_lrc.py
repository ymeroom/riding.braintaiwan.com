...
# 1. CDN test
urls = [
    f"https://cdn1.suno.ai/{sample_id}.lrc",
    f"https://cdn2.suno.ai/{sample_id}.lrc",
    f"https://studio-api.prod.suno.com/api/clip/{sample_id}/lrc",
    f"https://studio-api.prod.suno.com/api/clip/{sample_id}/lyrics",
    f"https://studio-api.prod.suno.com/api/lyrics/{sample_id}",
    f"https://studio-api.prod.suno.com/api/clip/{sample_id}/aligned_lyrics",
    f"https://studio-api.prod.suno.com/api/clip/{sample_id}/transcript",
    f"https://studio-api.prod.suno.com/api/feed/v2?ids={sample_id}"
]
