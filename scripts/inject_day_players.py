...
def process_html(filename):
    ...
    for day, track in best_tracks.items():
        ...
        <div class="theme-music-player" data-track="{song_id}">
            ...
            <audio src="assets/audio/day{day}.mp3" preload="none" ontimeupdate="updateThemePlayerProgress(this)" onloadedmetadata="setPlayerDuration(this)" onended="resetThemePlayer(this)"></audio>
        </div>'''
