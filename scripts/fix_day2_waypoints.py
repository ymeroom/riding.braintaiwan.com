...
# True Road Coordinates for Day 2 Plan B
# 1. Mt. Takao Base Camp (Takaosanguchi station): 35.6323, 139.2705 (Alt 190m)
# 2. Otarumi Pass (Rt 20 crest): 35.6250, 139.2360 (Alt 392m)
# 3. Sagamiko / Yose: 35.6170, 139.1900 (Alt 205m)
# 4. Prefectural Road 35 Entry (Nagura / Akiyama Kaido): 35.5840, 139.1450 (Alt 245m)
# 5. Akiyama Onsen / Kami-Akiyama: 35.5680, 139.0500 (Alt 400m)
# 6. Hinata Tunnel / Akiyama Tunnel crest: 35.5650, 138.9700 (Alt 560m)
# 7. Yukari Ryokan (Tsuru City): 35.55057, 138.90582 (Alt 484m)

waypoints = [
    {"name": "起點：Mt. Takao Base Camp (高尾山口)", "desc": "08:00 出發，海拔 190m。清晨車流稀少，精神飽滿", "lon": 139.2705, "lat": 35.6323, "type": "start"},
    {"name": "第一爬坡：大垂水峠（おおだるみとうげ）", "desc": "長度 4.2km，爬升約 202m，平均坡度 4.8%。清晨車少，順暢登頂！", "lon": 139.2360, "lat": 35.6250, "type": "climb1"},
    {"name": "下坡俯衝：相模湖畔（さがみこ）", "desc": "暢快下坡 3.5km 直達相模湖底（海拔 205m），欣賞晨霧湖光", "lon": 139.1900, "lat": 35.6170, "type": "lake"},
    {"name": "⚡ 關鍵轉折：左轉切入「山梨縣道35號（秋山街道）」", "desc": "【避坑核心】在此徹底脫離國道20號！進入零貨車之幽靜溪谷", "lon": 139.1450, "lat": 35.5840, "type": "pivot"},
    {"name": "幽靜溪谷：秋山溫泉・秋山街道", "desc": "沿秋山川平緩上坡，兩側深秋楓紅，山林幽靜無比", "lon": 139.0500, "lat": 35.5680, "type": "valley"},
    {"name": "全日最高點：秋山隧道・日向峠（海拔 560m）", "desc": "順利征服全日最高點！穿過隧道即進入下坡階段", "lon": 138.9700, "lat": 35.5650, "type": "crest"},
    {"name": "終點：商務旅館 由加利（ビジネス旅館 由加利）", "desc": "都留市上谷 1 丁目 3-4，海拔 484m。下午 13:30 輕鬆抵達 check-in", "lon": 138.90582, "lat": 35.55057, "type": "end"}
]

print("Calculating exact OSRM road trajectory for Day 2...")
...
print(f"OSRM Day 2 True Road Distance: {distance_km} km ({len(coordinates)} GPS points)")

# Sample GSI elevation along true road
elevations = []
...
# Filtered gain/loss (5m threshold)
gain = 0
loss = 0
...
print(f"Final Stats: Distance={distance_km}km, Ascent=+{gain}m, Descent=-{loss}m, Start={start_e}m, End={end_e}m, Max={max_e}m")
...
navitime_url = "https://www.navitime.co.jp/maps/routeSearch?start=%7B%22lat%22%3A35.6323%2C%22lon%22%3A139.2705%2C%22name%22%3A%22Mt.Takao+Base+Camp%22%7D&goal=%7B%22lat%22%3A35.55057%2C%22lon%22%3A138.90582%2C%22name%22%3A%22%E7%94%B1%E5%8A%A0%E5%88%A9%E6%97%85%E9%A4%A8%22%7D&via=%5B%7B%22lat%22%3A35.6250%2C%22lon%22%3A139.2360%2C%22name%22%3A%22%E5%A4%A7%E5%9E%82%E6%B0%B4%E5%B3%A0%22%7D%2C%7B%22lat%22%3A35.5840%2C%22lon%22%3A139.1450%2C%22name%22%3A%22%E7%A7%8B%E5%B1%B1%E8%A1%97%E9%81%93%E5%85%A5%E5%8F%A3%22%7D%5D"
gmaps_origin = "35.6323,139.2705"
gmaps_dest = "35.55057,138.90582"
gmaps_waypoints = "35.6250,139.2360|35.5840,139.1450|35.5650,138.9700"
...
# Build HTML Map Demo with Leaflet
...
<div class="container">
    ...
    <div class="stats-bar">
        ...
        <div class="stat-box">
            <div class="val">190m ➔ 560m ➔ 484m</div>
    ...
    <div class="chart-card">
        <h3>
            ...
            <span style="font-size: 12px; color: #F59E0B;">第一段：大垂水峠 (+202m) ｜ 第二段：秋山溪谷緩升 (+315m)</span>
        </h3>
    ...
    <div class="tip-callout">
        ...
        <br>2. <strong>相模湖立即左轉「縣道 35 號（秋山街道）」：</strong> 徹底脫離國道 20 號！沿秋山川溪谷一路享受楓紅與清泉，最高點秋山隧道（560m）後滑降至都留市「由加利旅館」。
    </div>
