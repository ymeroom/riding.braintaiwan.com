...
.rd-escalate{display:block;margin:2px 0 14px;padding:13px 16px;border-radius:10px;background:#DC2626;
  color:#fff;font-weight:800;font-size:14px;text-decoration:none;text-align:center;line-height:1.5;
  box-shadow:0 2px 8px rgba(220,38,38,.3)}
.rd-escalate:active{background:#B91C1C}
</style>
</head>
<body>
<div class="rd-head">
...
<a class="rd-escalate" href="https://ymeroom.github.io/biking-gps-weather/" target="_blank" rel="noopener">☔ 已經在下、要硬騎穿過去？→ 開 GPS 精細版（JMA 官方雷達＋定位＋幽靈點）</a>
</div>
