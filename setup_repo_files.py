...
# 1. Copy master itinerary to index.html
shutil.copyfile("d:/2026東京單車騎旅/tokyo_fuji_cycling_itinerary_19days_v2.html", "d:/2026東京單車騎旅/index.html")
shutil.copyfile("d:/2026東京單車騎旅/tokyo_fuji_cycling_itinerary_19days_v2.html", "C:/Users/ymero/Downloads/index.html")

# 2. Write CNAME for custom domain
with open("d:/2026東京單車騎旅/CNAME", "w", encoding="utf-8") as f:
    f.write("riding.braintaiwan.com\n")
...
.vscode/
"""
with open("d:/2026東京單車騎旅/.gitignore", "w", encoding="utf-8") as f:
    f.write(gitignore_content)

# 4. Create rich README.md
readme_content = """# 🚴 2026 東京・富士五湖・伊豆・東京灣 19日秋季單車騎旅 (19-Day Autumn Cycling Expedition)
...
with open("d:/2026東京單車騎旅/README.md", "w", encoding="utf-8") as f:
    f.write(readme_content)

print("Created index.html, CNAME, .gitignore, and README.md successfully!")
