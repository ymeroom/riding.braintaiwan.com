...
# Generate Master Suno AI Soundtrack HTML with balanced bilingual lyrics
html_content = f'''<!DOCTYPE html>
<html lang="zh-TW">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>東京・富士五湖・伊豆・東京灣 19日單車騎旅 ｜ 19首 Suno AI 官方台日雙語全量音樂詞庫 (50:50 中日平衡版)</title>
    <style>
        :root {{
            --bg-dark: #0B0F19;
            --card-bg: #131D2F;
...
<div class="container">
    <header>
        <div class="header-title">
            ...
            <p>🎵 19首 Suno AI 官方台日雙語全量音樂詞庫 ｜ 50:50 中日平衡版 ✕ J-POP ✕ Anime Rock ✕ Anisong ✕ 聖地巡禮</p>
        </div>
        <div class="nav-links">
    ...
    html_content += f'''    <div class="track-card" id="track-{t['track']}">
        ...
        <div class="prompt-box">
            <div class="prompt-header">
                ...
                <button class="copy-btn" onclick="copyText('prompt-{t[\'track\']}', this)">複製風格詞</button>
            </div>
...
print("Master 19-Track Suno AI Balanced Bilingual Soundtrack HTML successfully updated at suno_cycling_soundtrack_19days.html!")
